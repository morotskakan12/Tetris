...
public class blockGreenGraphics extends BlockAbstrakt {
    ...
    public Pane blockLayout(Pane _gameBord, int horizontally, int vertical,int angleNum) {
        ...
        for (int i = vertical; i <= vertical+(2*25); i = i+25){
            for(int e = horizontally; e <= horizontally+25;e=e+25 ){
                if (((e==horizontally+25)&&(i==vertical+25))||((e == horizontally+25)&&(i==vertical+50))){
                    ...
                    _gameBord = setBlock(_gameBord,(int)horizontallyTemp,(int)verticalTemp, Color.rgb(25,195,19),Color.rgb(115,11,11));}
            }
        }
