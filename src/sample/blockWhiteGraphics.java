        ...
        for (int i = horizontally; i <= horizontally+(2*25); i = i+25){
            for(int e = vertical; e <= vertical+25; e=e+25 ){
                if (((i==horizontally)&&(e==vertical))||((i == horizontally+(2*25))&&(e==vertical))){
                    ...
                    _gameBord = setBlock(_gameBord,(int)temp1,(int)temp2, Color.rgb(224,224,224),Color.rgb(115,11,11));
            }
            }
        }
